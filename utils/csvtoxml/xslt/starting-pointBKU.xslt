<xsl:stylesheet xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0' 
	...
	xmlns:usgin="http://resources.usgin.org/xslt" 
	xmlns:fn="http://www.w3.org/2005/xpath-functions">
	<xsl:output encoding="UTF-8" indent="yes" omit-xml-declaration="no"/>
	<!-- This xslt takes an xml record generated by the csvToXML python routine and transforms to a USGIN profile ISO XML record -->
	<xsl:template match="record">
		...
		<!--	<xsl:if test="(distributor_contact_person_name != '') or (distributor_contact_org_name != '') or (distributor_contact_position_name != '')">-->
